...
#1. 
{
  CFPB0 <- read_csv("C:/Users/whaler/Desktop/Machine learning/group project/sample26.01.csv")
  ZIPCODES <- read_csv("C:/Users/whaler/Desktop/Machine learning/group project/zip_fips.csv")
...
{
  # Medical debt
  med_debt_raw <- read_excel("C:/Users/whaler/Desktop/Machine learning/group project/changing_med_debt_landscape_county.xlsx", 
                             sheet = 1,
...
#5.
{
  ...
  county_debt <- read_csv("C:/Users/whaler/Desktop/Machine learning/group project/household-debt-by-county.csv")
...
#6.
{
  AutoRetail <- read_excel("C:/Users/whaler/Desktop/Machine learning/group project/AutoRetail.xlsx")
  StudentLoan <- read_xlsx("C:/Users/whaler/Desktop/Machine learning/group project/StudentLoan.xlsx")
  OverallDebt <- read_xlsx("C:/Users/whaler/Desktop/Machine learning/group project/Overall.xlsx")
...
#7.
{
  INSECURE0 <- read_xlsx("C:/Users/whaler/Desktop/Machine learning/group project/credit-insecurity-index-data-workbook.xlsx", sheet = "County")
  tier_lookup <- c(
    "Credit At Risk"  = 1,
...
#8.
{
  ...
  FMR22 <- read_xlsx("C:/Users/whaler/Desktop/Machine learning/group project/FY22_FMRs_revised.xlsx")|>
    rename(fips = fips2010,
           ...
           "FourRoom_2022"  = fmr_4)
  FMR23 <- read_xlsx("C:/Users/whaler/Desktop/Machine learning/group project/FY23_FMRs_revised.xlsx") |>
    rename("Studio_2023"    = fmr_0,
           "OneRoom_2023"   = fmr_1,
           "TwoRoom_2023"   = fmr_2,
           "ThreeRoom_2023" = fmr_3,
           "FourRoom_2023"  = fmr_4)
  FMR24 <- read_xlsx("C:/Users/whaler/Desktop/Machine learning/group project/FMR2024_final_revised.xlsx") |>
    rename("Studio_2024"    = fmr_0,
           "OneRoom_2024"   = fmr_1,
           "TwoRoom_2024"   = fmr_2,
           "ThreeRoom_2024" = fmr_3,
           "FourRoom_2024"  = fmr_4)
  FMR25 <- read_xlsx("C:/Users/whaler/Desktop/Machine learning/group project/FY25_FMRs_revised.xlsx")|>
  ...
  compiled_county_education_measures <- read_csv("C:/Users/whaler/Desktop/Machine learning/group project/compiled_county_education_measures.csv")|>
